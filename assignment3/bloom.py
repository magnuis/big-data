...
def reset_filter():
    '''
    :return: empty dictionary with n keys, each with value 0
    '''    
...
if __name__ == '__main__':
    ...
    # TODO remove print
    # print(f"There are a total of {sum(filter.values())} 1s out of the {len(filter.values())} entries in the bloom filter \n")
